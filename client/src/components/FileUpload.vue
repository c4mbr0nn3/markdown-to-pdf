  ...
  <div class="space-y-6">
    ...
    >
      ...
      <div class="text-center">
        ...
        <div class="flex justify-center space-x-2">
          <UBadge color="blue" variant="soft">Markdown: .md, .markdown</UBadge>
          <UBadge color="green" variant="soft">Images: .png, .jpg, .jpeg</UBadge>
        </div>
    ...
    <div v-if="files.length > 0" class="bg-gray-50 rounded-lg p-4">
      <div class="flex items-center justify-between mb-3">
        <h4 class="text-sm font-medium text-gray-900">Upload Status</h4>
        <UButton 
          color="red" 
          variant="soft" 
          size="xs" 
