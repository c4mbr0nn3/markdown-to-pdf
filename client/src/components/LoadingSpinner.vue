<template>
  <div class="flex flex-col items-center justify-center p-8">
    <!-- Spinner Animation -->
    <div class="relative">
      <div class="h-12 w-12 rounded-full border-4 border-gray-200 animate-spin border-t-blue-600"></div>
    </div>
    ...
    <div v-if="showDetails" class="mt-6 max-w-md">
      <div class="bg-gray-50 rounded-lg p-4">
        <h4 class="text-sm font-medium text-gray-900 mb-2">Process Details</h4>
        <div class="space-y-2">
          <div 
